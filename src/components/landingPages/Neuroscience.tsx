        ...
        <div className="min-h-screen pt-[62px]">
            ...
            <section id="science" className="py-24 relative overflow-hidden">
                <CommonWrapper>
                    <div className="mb-20 space-y-4">
                        ...
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white font-cormorant leading-tight">
                            What Neuroscience Tells Us About <br /><span className="text-primary italic">How People Learn</span>
                        </h2>
                        <p className="text-white/60 text-lg max-w-4xl font-outfit leading-relaxed">
                            Learning is not a simple transfer of information from a screen to a brain. The brain has to <span className="text-white font-bold">receive, process, connect, and store</span> new knowledge. Neuroscience shows us that this process looks very different depending on who the learner is.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-x-16 gap-y-12">
                        {[
                            {
                                title: "Prior Knowledge Shapes Everything",
                                desc: <>The brain stores new information by connecting it to what it already knows. This is called <span className="text-white font-bold italic">schema theory</span>. If a learner already knows something about the topic, the new information is absorbed much faster. If they know nothing, the brain needs more time and more examples before the connection is made. The IKON SKILLS™ pre-test reads the learner&apos;s existing knowledge before anything else.</>
                            },
                            {
                                title: "The Zone of Proximal Development",
                                desc: <>Psychologist Lev Vygotsky showed that people learn best when they are taught just beyond what they already know, but not so far that they become lost. Too easy, and the brain switches off. Too hard, and the learner gives up. The AI engine finds this exact zone for each individual practitioner and stays there throughout the learning journey.</>
                            },
                            {
                                title: "Working Memory Has a Limit",
                                desc: <>The human brain can only hold a small amount of new information at one time. This is called <span className="text-white font-bold italic">cognitive load theory</span>. If a learner is overwhelmed with too much content at once, learning fails. The AI engine paces content delivery to match each practitioner&apos;s cognitive bandwidth, not a fixed content schedule.</>
                            },
                            {
                                title: "Emotion and Relevance Drive Memory",
                                desc: <>The brain&apos;s memory center, the <span className="text-white font-bold italic">hippocampus</span>, works closely with the emotional center, the <span className="text-white font-bold italic">amygdala</span>. Learners remember information much better when it is connected to real-life examples that feel relevant and meaningful to them. Generic examples fade. Personal, contextual examples stick. IKON SKILLS™ delivers real-life scenarios matched to each practitioner&apos;s context.</>
                            },
                            {
                                title: "The Spacing and Retrieval Effect",
                                desc: <>Neuroscience research consistently shows that we retain knowledge far better when we are tested on it, rather than just reading it. This is the <span className="text-white font-bold italic">testing effect</span>. Additionally, spacing practice over time builds deeper memory traces. The IKON SKILLS™ formative assessment loops do exactly this: they repeatedly retrieve knowledge and reinforce it at the right moments.</>
                            },
                            {
                                title: "Feedback Closes the Learning Loop",
                                desc: <>When the brain receives immediate, specific feedback after a response, it can correct its own patterns. This is how neural pathways are strengthened. Vague feedback does very little. Precise, timely feedback changes learning outcomes dramatically. Every assessment in the IKON SKILLS™ system is followed by targeted feedback, not just a score.</>
                            }
                        ].map((p, i) => (
                            <div key={i} className="pl-6 border-l-[3px] border-primary/40 space-y-4 hover:border-primary transition-colors">
                                <h3 className="text-xl font-bold text-[#49cbc7] font-outfit uppercase tracking-wide">{p.title}</h3>
                                <p className="text-white/50 leading-[1.8] font-outfit text-sm md:text-[15px]">
                                    {p.desc}
                                </p>
                            </div>
                        ))}
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <CommonWrapper>
                    ...
                    <div className="mt-20 p-8 md:p-12 rounded-[40px] bg-gradient-to-br from-primary/10 to-transparent border border-primary/20   mx-auto space-y-8">
