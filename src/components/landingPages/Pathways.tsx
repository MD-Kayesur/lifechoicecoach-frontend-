...
export const Pathways = () => {
    ...
    return (
        <div id="page-pathways" className="page active pt-[62px] min-h-screen bg-[#070c14] relative overflow-hidden font-outfit">
            {/* ═══════ ABSTRACT BACKGROUND ═══════ */}
            ...
            <div className="page-content relative z-1">
                ...
                <div className="cp-hero bg-[linear-gradient(135deg,#040810_0%,#070C14_50%,#0A1020_100%)] px-10 py-20 text-center relative overflow-hidden border-b border-gold/30">
                    ...
                    <div className="hero-meta flex justify-center gap-6 flex-wrap">
                        <span className="hero-pill bg-white/6 border border-white/10 rounded-[20px] px-3.5 py-1.5 text-[12px] text-[#94A3B8]">100% Online</span>
                        <span className="hero-pill bg-white/6 border border-white/10 rounded-[20px] px-3.5 py-1.5 text-[12px] text-[#94A3B8]">Self-Paced</span>
                        <span className="hero-pill bg-white/6 border border-white/10 rounded-[20px] px-3.5 py-1.5 text-[12px] text-[#94A3B8]">AI-Native</span>
                        <span className="hero-pill bg-white/6 border border-white/10 rounded-[20px] px-3.5 py-1.5 text-[12px] text-[#94A3B8]">EIU-Paris Conferred</span>
                        <span className="hero-pill bg-white/6 border border-white/10 rounded-[20px] px-3.5 py-1.5 text-[12px] text-[#94A3B8]">Launching June 2026</span>
                    </div>
                </div>

                {/* STACKING BANNER */}
                <div className="stacking-banner bg-[linear-gradient(90deg,rgba(203,45,57,.10),rgba(203,45,57,.15),rgba(203,45,57,.10))] border-y border-gold/20 px-10 py-4 flex justify-center gap-12 flex-wrap text-center">
                    <div className="stack-item flex items-center gap-3">
                        <div className="stack-num font-mono text-[22px] font-bold text-gold">18</div>
                        <div className="stack-txt text-[12px] text-[#94A3B8] leading-[1.4] text-left"><strong className="text-white block text-[13px]">Bachelor Degree</strong>Micro-Credentials required</div>
                    </div>
                    <div className="stack-sep text-gold/40 text-[20px] flex items-center">→</div>
                    <div className="stack-item flex items-center gap-3">
                        <div className="stack-num font-mono text-[22px] font-bold text-gold">24</div>
                        <div className="stack-txt text-[12px] text-[#94A3B8] leading-[1.4] text-left"><strong className="text-white block text-[13px]">Master Degree</strong>Micro-Credentials required</div>
                    </div>
                    <div className="stack-sep text-gold/40 text-[20px] flex items-center">→</div>
                    <div className="stack-item flex items-center gap-3">
                        <div className="stack-num font-mono text-[22px] font-bold text-gold">36</div>
                        <div className="stack-txt text-[12px] text-[#94A3B8] leading-[1.4] text-left"><strong className="text-white block text-[13px]">Doctor of Practice</strong>Micro-Credentials required</div>
                    </div>
                    <div className="stack-sep text-gold/40 text-[20px] flex items-center">·</div>
                    <div className="stack-item flex items-center gap-3">
                        <div className="stack-num font-mono text-[22px] font-bold text-gold">$14.99</div>
                        <div className="stack-txt text-[12px] text-[#94A3B8] leading-[1.4] text-left"><strong className="text-white block text-[13px]">Per Micro-Credential</strong>Most affordable globally</div>
                    </div>
                </div>
